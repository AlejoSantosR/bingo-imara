...
const ATOMIC=new Set(['finance-update','finance-card-status','admin-sale-record','finance-payment-add','finance-order-payment-add','finance-order-payment-set','finance-contact-update','finance-bulk-correct']);
