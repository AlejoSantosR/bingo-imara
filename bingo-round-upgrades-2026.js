...
function renderTieWinner(s){
 ...
 o.innerHTML='<canvas class="tie10-confetti"></canvas><div class="tie10-card tie10-winner-card"><div class="tie10-halo"></div><div style="position:relative;font-size:12px;letter-spacing:3px;font-weight:1000;color:#ffdca0">BINGO IMARA · RESULTADO OFICIAL</div><div class="tie10-trophy">🏆</div><div class="tie10-ribbon">✨ GANADOR ✨</div><div class="tie10-winner-name">'+esc(w.buyer_alias||w.card_id||'GANADOR')+'</div><div class="tie10-winner-cardid">'+esc(w.card_id||'')+'</div>'+prizeBlock+'<div class="tie10-sub">Resultado confirmado. La ronda quedó cerrada.</div><button type="button" class="tie10-sound" id="tie10Sound">🔊 '+(audioCtx?.state==='running'?'Sonido activo':'Activar sonido')+'</button></div>';
